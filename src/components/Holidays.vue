...
<template>
  <article
    ...
    :key="index"
    :class="['flex', 'flex-row', 'justify-between', 'p-5', 'w-full', 'bg-sky-950', 'text-white', 'rounded', 'shadow-secondary-1', {'order-1 opacity-80 first:mt-16 hover:opacity-100': isHolidayPassed(holiday.date)}]"
  >
    <div class="w-full">
      <h4 class="text-xl tracking-wide hyphens-auto">{{ holiday.title }}</h4>
    ...
    <div class="bg-slate-900 py-2 px-4 h-14 rounded place-content-center text-xl select-none" >
